...
const VerifyEmail: React.FunctionComponent<IVerifyEmailProps> = (props) => {
  ...
  return (
    <>
      <br />
      <div className="w-screen h-screen w-full h-full" id="fullscreen">
        ...
        <div className=" relative" id="relative">
          <div className="px-2 py-2 mx-auto my-auto max-w-7xl md:max-h-2xl md:py-6">
            ...
            <br />
            <Link to='/'> <button className=" flex items-center justify-center h-screeninline-block align-middle focus:ring-2 focus:ring-offset-2 focus:ring-green-700 text-sm font-semibold leading-none text-white focus:outline-none bg-pink-700 border rounded hover:bg-purple-600 py-3 w-40 center"> Regresar </button></Link>
          </div>
